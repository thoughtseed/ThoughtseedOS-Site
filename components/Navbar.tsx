    ...
    <>
      <nav className="fixed top-0 left-0 w-full z-50 bg-white/80 dark:bg-cosmic-dark/80 backdrop-blur-md border-b border-gray-200 dark:border-white/10 px-4 py-4 md:px-8 transition-colors duration-300">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div 
            className="text-2xl font-black uppercase tracking-tighter cursor-pointer select-none font-sans flex items-center gap-2 text-neo-black dark:text-white"
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
          >
            <div className="w-6 h-6 bg-neo-black dark:bg-neo-lime"></div>
            Thoughtseed
          </div>
